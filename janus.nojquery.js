const adapter = require('webrtc-adapter').default
// List of sessions
Janus.sessions = {}
...
Janus.init = function (options) {
  ...
  if (Janus.initDone === true) {
    ...
    Janus.ajax = function (params) {
      ...
      if (params.withCredentials !== null && params.withCredentials !== undefined) { XHR.withCredentials = params.withCredentials }
      if (params.async) {
              ...
              stats.forEach(function (res) {
                ...
                if (inStats) {
                  ...
                  if (config.bitrate.bsbefore === null || config.bitrate.tsbefore === null) {
                    ...
                    if (adapter.browserDetails.browser == 'safari') { timePassed = timePassed / 1000 }	// Apparently the timestamp is in microseconds, in Safari
